...
?>
        <!DOCTYPE html>
<html class="no-js" lang="{{ ietfLangTag(config('app.locale')) }}"{!! (config('lang.direction')=='rtl') ? ' dir="rtl"' : '' !!}>
<head>
    <meta charset="utf-8">
    ...
    {{--	<link href="{{ url('dist/assets/css/style.css') . getPictureVersion() }}" rel="stylesheet">--}}
    @yield('after_styles')
...
<!-- CSS
    ...
    <!-- Plugins CSS -->
    <link rel="stylesheet" href="{{url('dist/assets/css/plugins.css')}}">
    <!-- Main Style CSS -->
...
<!-- Map Active JS -->
<script src="{{url('dist/assets/js/maplace-active.js')}}"></script>
<!-- Main JS -->
